...
public class TransmiterMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.firebaseKeyToUse = this.getIntent().getStringExtra("carkey");

        Log.d(TAG, "key Obtained is|" + this.firebaseKeyToUse + "|");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title("Transmitter Map"));
